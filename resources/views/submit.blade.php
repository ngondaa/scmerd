...
<style>
    ...
    .cp-input, .cp-textarea, .cp-select { width: 100%; border: 1px solid #e0e0ee; border-radius: 12px; padding: 10px 14px; font-size: 13px; font-family: inherit; color: #1a1a2e; background: #fff; transition: border-color 0.15s; outline: none; }
    ...
    <div class="cp-card">
        ...
        <form method="POST" action="{{ route('submit.store') }}" enctype="multipart/form-data">
            ...
            <div class="cp-form-group">
                ...
                <textarea id="abstract" name="abstract" rows="8" required class="cp-textarea">{{ old('abstract') }}</textarea>
