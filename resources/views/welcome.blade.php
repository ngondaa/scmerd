...
<head>
    ...
    <meta name="description" content="2026 SAIMechE Central Branch Postgraduate Conference on Mechanical Engineering and Related Disciplines. University of the Witwatersrand, Johannesburg.">
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-nav:hover { background: #5649c0 !important; }
        .btn-nav-square { border-radius: 8px; padding: 8px 16px; }
        ...
        .ticket-price-row { display: flex; align-items: flex-end; gap: 12px; margin-bottom: 8px; }
        .ticket-price {
            font-family: 'Clash Display', sans-serif;
            font-size: 3rem;
            font-weight: 700;
        ...
        .ticket-note { font-size: .85rem; color: rgba(255,238,219,.6); margin-bottom: 20px; }
        .ticket-deadline {
            font-size: .9rem;
            color: var(--cream);
        ...
        .btn-ticket:hover { background: #e55a1a; transform: translateY(-1px); }
        .btn-ticket-square { border-radius: 8px; padding: 12px 18px; }
        .btn-ticket-outline {
        ...
        .marquee-sep { opacity: .4; margin: 0 8px; }
        ...
        #themes .section-heading { color: var(--navy); }
        #themes .section-tag { color: #2c5b5f; }
        .section-body {
        ...
        .about-img-text p { color: rgba(255,238,219,.7); font-size: .95rem; }
        .about-img-badge {
            position: absolute;
            bottom: -20px;
            right: -20px;
        ...
        .theme-card p { font-size: .88rem; color: rgba(0,26,45,.72); line-height: 1.5; }
        ...
        .date-card:nth-child(2)::before { background: var(--purple); }
        .date-card:nth-child(3)::before { background: var(--orange); }
        .date-card:hover { transform: translateY(-4px); border-color: var(--teal); }
        .date-card-label {
            font-size: .85rem;
            font-weight: 600;
            color: var(--teal);
        ...
        .date-card p { font-size: .88rem; color: rgba(255,238,219,.55); line-height: 1.5; }

        /* ── SPEAKERS ── */
        #speakers { background: var(--navy-2); }
        .speakers-grid {
            display: grid;
        ...
        .speaker-name { font-size: .9rem; color: var(--orange); font-weight: 600; margin-bottom: 8px; }
        .speaker-bio { font-size: .82rem; color: rgba(255,238,219,.55); line-height: 1.5; }
        ...
        .program-dot.break { background: var(--orange); box-shadow: 0 0 0 2px rgba(248,102,36,.3); }
        .program-title {
            font-family: 'Clash Display', sans-serif;
            font-size: .95rem;
            font-weight: 600;
        ...
        .program-detail { font-size: .8rem; color: rgba(255,238,219,.5); line-height: 1.4; }
        .program-sessions {
            display: flex;
            flex-wrap: wrap;
            gap: 6px;
        ...
        .btn-cta:hover { background: #e55a1a; transform: translateY(-2px); color: #fff; }
        .cta-perforation {
            width: 24px;
            background: var(--cream);
            position: relative;
        ...
        .cta-perforation::before, .cta-perforation::after {
            content: '';
            position: absolute;
        ...
        .cta-perforation::before { top: -12px; }
        .cta-perforation::after  { bottom: -12px; }
        .perf-dots {
            display: flex;
            flex-direction: column;
            gap: 8px;
        ...
        .feature-cell p { font-size: .9rem; color: rgba(255,238,219,.55); line-height: 1.6; }

        /* ── SUBMISSION ── */
        #submission { background: var(--navy-2); }
        .submission-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 48px; margin-top: 48px; }
        .submission-info {}
        .submission-info ul { list-style: none; display: flex; flex-direction: column; gap: 16px; margin-top: 24px; }
        .submission-info li {
            display: flex;
            gap: 14px;
            align-items: flex-start;
        ...
        .submission-info li .li-text { font-size: .9rem; color: rgba(255,238,219,.7); line-height: 1.5; }
        .submission-info li .li-text strong { color: var(--cream); }
        .submission-side {}
        .template-card {
            background: rgba(255,238,219,.04);
            border: 1px solid rgba(112,171,175,.15);
        ...
        .template-name { font-size: .9rem; font-weight: 600; color: var(--cream); }
        .template-detail { font-size: .8rem; color: rgba(255,238,219,.5); margin-top: 2px; }
        .btn-dl {
            background: var(--purple);
            color: var(--cream);
            font-size: .8rem;
        ...
        .btn-dl:hover { background: #5649c0; color: var(--cream); }
        .submit-cta-box {
            background: var(--purple);
            border-radius: 16px;
            padding: 32px 28px;
        ...
        .submit-cta-box p { font-size: .88rem; color: rgba(255,238,219,.7); margin-bottom: 20px; }
        .btn-submit {
            display: inline-block;
            background: var(--orange);
            color: #fff;
        ...
        .btn-submit:hover { background: #e55a1a; color: #fff; }
        ...
        .reg-table tr:hover td { background: rgba(112,171,175,.04); }
        .price-highlight { color: var(--orange); font-weight: 700; font-family: 'Clash Display', sans-serif; }
        .reg-note {
            margin-top: 24px;
        ...
        .venue-address { font-size: .95rem; color: rgba(255,238,219,.65); line-height: 1.8; margin-bottom: 32px; }
        .venue-map {
            border-radius: 20px;
            overflow: hidden;
            border: 1px solid rgba(112,171,175,.15);
        ...
        .venue-map iframe { width: 100%; height: 340px; border: none; border-radius: 14px; }
        .venue-photo {
            border-radius: 20px;
            overflow: hidden;
            height: 220px;
        ...
        .contact-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 64px; align-items: center; margin-top: 48px; }
        .contact-info p { color: rgba(255,238,219,.65); font-size: 1rem; line-height: 1.7; margin-bottom: 28px; }
        .contact-email {
            display: inline-flex;
            align-items: center;
            gap: 12px;
            background: rgba(255,238,219,.05);
            border: 1px solid rgba(112,171,175,.2);
            border-radius: 14px;
            padding: 18px 24px;
            text-decoration: none;
        ...
        .contact-email:hover { border-color: var(--teal); background: rgba(112,171,175,.08); color: var(--cream); }
        ...
        .contact-card strong { display: block; color: var(--teal); font-size: .85rem; margin-bottom: 6px; text-transform: uppercase; letter-spacing: .05em; }
        .contact-card p { font-size: .95rem; color: rgba(255,238,219,.7); }
        ...
        .footer-brand-sub { font-size: .85rem; color: var(--teal); margin-bottom: 16px; }
        .footer-contact { font-size: .9rem; color: rgba(255,238,219,.6); }
        ...
        @media (max-width: 1024px) {
            ...
            .about-grid, .speakers-grid, .program-grid,
            .submission-grid, .venue-grid, .contact-grid,
            .features-grid, .dates-grid, .themes-grid, .photo-gallery, .partners-logo-grid { grid-template-columns: 1fr; }
            .cta-card { flex-direction: column; }
            .cta-right { width: 100%; border-left: none; border-top: 1px dashed rgba(0,26,45,.15); }
            .cta-perforation { display: none; }
...
<section id="hero">
    ...
    <div class="hero-grid">
        <div class="hero-left">
            <span class="hero-tag">2026 edition · University of the Witwatersrand</span>
            <h1 class="hero-title">2026 SAIMechE Central Branch Postgraduate Conference</h1>
            <p class="hero-subtitle">Actionable insights for postgraduate engineers, researchers and industry collaborators</p>
        ...
        <div class="ticket-card">
            ...
            <div class="ticket-card-top">
                <div>
                    <div class="ticket-label">Early Bird Registration</div>
                    <div class="ticket-sublabel">Limited availability · Early registration now open</div>
                </div>
                <div class="ticket-badge">SAVE ZAR 500</div>
            </div>
            <div class="ticket-price-row">
                <span class="ticket-price">ZAR 1500</span>
                <span class="ticket-price-was">ZAR 2000</span>
            </div>
            <div class="ticket-note">Postgraduate conference pass · conference materials included</div>
            <div class="ticket-deadline">Paper submission deadline: <strong>8 October 2026</strong></div>
            <a class="btn-ticket" href="https://cmt3.research.microsoft.com/SCMERD2025" target="_blank">Register Now</a>
        </div>
    </div>
</section>
    ...
    <div class="section-inner">
        <div class="about-grid">
            <div class="about-text">
                ...
                <h2 class="section-heading">SAIMechE Postgraduate Conference explores advanced engineering research.</h2>
                <p class="section-body">The conference will be held at the University of the Witwatersrand, Johannesburg, South Africa, with satellite online venues at other regional universities.<br><br>Our speakers inform, challenge and inspire across commercial, creative and technical domains. Join us for a full day of design and engineering inspiration, featuring keynote speakers, parallel technical sessions, and networking opportunities.</p>
                <br>
                <p class="section-body">The conference welcomes original research or review manuscripts that have not been published or submitted elsewhere for possible presentation and publication.</p>
                <br>
                <a href="/SAIMechE conference flyer 2025.pdf" target="_blank" class="btn-ticket" style="display:inline-block; margin-top:12px; font-size:.9rem; padding:12px 28px;">Download 2026 Flyer</a>
            </div>
            <div class="about-img-wrap">
                <div class="about-img-box">
                    <div class="about-img-text">
                        <h3>University of the Witwatersrand</h3>
                        <p>South West Engineering Building<br>East Campus · Jan Smuts Avenue<br>Braamfontein, Johannesburg</p>
                    </div>
                </div>
                <div class="about-img-badge">1 Day<br>Conference<br>Hybrid</div>
            </div>
        </div>
    </div>
</section>
...
<section id="themes">
    <div class="section-inner">
        ...
        <div class="themes-grid">
            <div class="theme-card"><div class="theme-icon">T01</div><h4>Mechanical Design</h4><p>Computational simulations, models and solid mechanics</p></div>
            <div class="theme-card"><div class="theme-icon">T02</div><h4>Fluid Mechanics</h4><p>Aerodynamics, flow dynamics and computational fluid dynamics</p></div>
            <div class="theme-card"><div class="theme-icon">T03</div><h4>Mechatronics</h4><p>Integration of mechanical, electrical and computing systems</p></div>
            <div class="theme-card"><div class="theme-icon">T04</div><h4>Materials Science</h4><p>Materials design, testing and advanced manufacturing processes</p></div>
            <div class="theme-card"><div class="theme-icon">T05</div><h4>Energy Systems</h4><p>Energy, renewable energy and engine and fuel technology</p></div>
            <div class="theme-card"><div class="theme-icon">T06</div><h4>Operations Research</h4><p>Lean manufacturing, industrial processes and optimisation</p></div>
        </div>
    </div>
</section>
    ...
    <div class="section-inner">
        ...
        <div class="dates-grid">
            <div class="date-card">
                ...
                <p>Final deadline for all paper submissions including abstracts, extended abstracts, and full papers.</p>
            </div>
            <div class="date-card">
                <div class="date-card-label">Acceptance</div>
                <h3>Notice of acceptance</h3>
                <div class="date-card-value" style="color: var(--purple); font-size:1.2rem; padding-top:4px;">Rolling notice</div>
...
<section id="gallery">
    <div class="section-inner">
        ...
        <div class="photo-gallery">
            <div class="gallery-item"><img src="/images/3.jpeg" alt="Conference moment 1"></div>
            <div class="gallery-item"><img src="/images/4.jpeg" alt="Conference moment 2"></div>
            <div class="gallery-item"><img src="/images/5.jpeg" alt="Conference moment 3"></div>
            <div class="gallery-item"><img src="/images/6.jpeg" alt="Conference moment 4"></div>
            <div class="gallery-item"><img src="/images/7.jpeg" alt="Conference moment 5"></div>
            <div class="gallery-item"><img src="/images/8.jpeg" alt="Conference moment 6"></div>
            <div class="gallery-item"><img src="/images/9.jpeg" alt="Conference moment 7"></div>
            <div class="gallery-item"><img src="/images/10.jpeg" alt="Conference moment 8"></div>
        </div>
    </div>
</section>
    ...
    <div class="cta-inner">
        <div class="cta-card">
            <div class="cta-left">
                ...
                <a class="btn-cta" href="https://cmt3.research.microsoft.com/SCMERD2025" target="_blank">Submit Your Paper</a>
            </div>
            ...
            <div class="cta-right">
                ...
                <div class="cta-right-was">ZAR 2000</div>
                <p style="font-size:.78rem; color:rgba(0,26,45,.5); margin-top:8px;">excl. VAT · African delegates</p>
            </div>
        </div>
    </div>
</section>
...
<section id="features">
    <div class="section-inner">
        <span class="section-tag">Why Attend</span>
        <h2 class="section-heading">What you'll gain at SAIMechE PGC 2026</h2>
        <div class="features-grid">
            <div class="feature-cell">
                <div class="feature-icon">01</div>
                <div class="feature-num">01</div>
                <h3>Practical Presentations</h3>
                <p>Get hands-on insights from technical papers, extended abstracts and research presentations across parallel sessions covering all conference themes.</p>
            </div>
            <div class="feature-cell">
                <div class="feature-icon">02</div>
                <div class="feature-num">02</div>
                <h3>Brilliant Keynote Speakers</h3>
                <p>Our speakers share actionable research insights. Expect to come away inspired, informed and equipped with practical knowledge you can apply in your field.</p>
            </div>
            <div class="feature-cell">
                <div class="feature-icon">03</div>
                <div class="feature-num">03</div>
                <h3>Connect With Product People</h3>
                <p>Meet like-minded postgraduate students, academics, and industry professionals building brilliant solutions in mechanical and related engineering disciplines.</p>
            </div>
            <div class="feature-cell">
                <div class="feature-icon">04</div>
                <div class="feature-num">04</div>
                <h3>DHET-Accredited Publication</h3>
                <p>Accepted papers will be published in EPJ Web of Conferences and Engineering Proceedings — Scopus-indexed, DHET-accredited proceedings available globally.</p>
            </div>
        </div>
    </div>
</section>
...
<section id="submission">
    <div class="section-inner">
        <span class="section-tag">Paper Submission</span>
        <h2 class="section-heading">How to submit your research</h2>
        <div class="submission-grid">
            <div class="submission-info">
                <ul>
                    <li><span>1.</span><div class="li-text"><strong>Original work only.</strong> Manuscripts must not have been published or submitted elsewhere for possible publication.</div></li>
                    <li><span>2.</span><div class="li-text"><strong>Paper length:</strong> Minimum <strong>10 pages</strong>, maximum <strong>14 pages</strong>. Only manuscripts relevant to the conference themes will be accepted.</div></li>
                    <li><span>3.</span><div class="li-text"><strong>Blind peer review.</strong> All submitted manuscripts undergo rigorous double-blind peer review by the scientific committee.</div></li>
                    <li><span>4.</span><div class="li-text"><strong>Hybrid conference.</strong> Both online and onsite presentations are welcome. Different registration fees apply for each mode.</div></li>
                    <li><span>5.</span><div class="li-text"><strong>Submission portal:</strong> All submissions via Microsoft CMT. This service is provided free of charge by Microsoft.</div></li>
                </ul>
            </div>
            <div class="ticket-card">
                <div class="ticket-corner"></div>
                <div class="ticket-card-top">
                    <div>
                        <div class="ticket-label">Submit Your Paper</div>
                        <div class="ticket-sublabel">Sign in to access the submission dashboard</div>
                    </div>
                    <div class="ticket-badge">CMT PORTAL</div>
                </div>
                <div class="ticket-price-row">
                    <span class="ticket-price" style="font-size:2rem;">Ready?</span>
                </div>
                <div class="ticket-note">Manage submissions, revisions, and final uploads from your account</div>
                <div class="ticket-deadline">Submission deadline: <strong>8 October 2026</strong></div>

                @auth
                    <a class="btn-ticket btn-ticket-square" href="{{ route('dashboard') }}">Go to Dashboard</a>
                @else
                    <div style="display:flex; gap:10px; flex-wrap:wrap;">
                        @if (Route::has('login'))
                            <a class="btn-ticket btn-ticket-square" href="{{ route('login') }}">Login</a>
                        @endif

                        @if (Route::has('register'))
                            <a class="btn-ticket btn-ticket-square btn-ticket-outline" href="{{ route('register') }}">Register</a>
                        @endif
                    </div>
                @endauth
            </div>
...
<section id="registration">
    <div class="section-inner">
        <span class="section-tag">Registration Fees</span>
        <h2 class="section-heading">Choose your registration option</h2>
        <div class="reg-table-wrap">
            <table class="reg-table">
                ...
                <tbody>
                    <tr>
                        <td>Abstract, extended abstract or technical paper only</td>
                        <td><span class="price-highlight">ZAR 500</span></td>
                        <td><span class="price-highlight">ZAR 1 000</span></td>
                    </tr>
                    <tr>
                        <td>Full paper – <strong style="color:var(--teal)">EPJ</strong> publishing option</td>
                        <td>
                            <span class="price-highlight">ZAR 1 500</span> African delegates<br>
                            <span class="price-highlight">ZAR 1 000</span> African students<br>
                            <span class="price-highlight">US$ 100</span> International
                        </td>
                        <td>
                            <span class="price-highlight">ZAR 2 000</span> African delegates<br>
                            <span class="price-highlight">ZAR 1 500</span> African students<br>
                            <span class="price-highlight">US$ 130</span> International
                        </td>
                    </tr>
                    <tr>
                        <td>Full paper – <strong style="color:var(--teal)">Engineering Proceedings</strong> option</td>
                        <td>
                            <span class="price-highlight">ZAR 3 000</span> African delegates<br>
                            <span class="price-highlight">ZAR 2 500</span> African students<br>
                            <span class="price-highlight">US$ 200</span> International
                        </td>
                        <td>
                            <span class="price-highlight">ZAR 3 500</span> African delegates<br>
                            <span class="price-highlight">ZAR 3 000</span> African students<br>
                            <span class="price-highlight">US$ 230</span> International
                        </td>
                    </tr>
                    <tr>
                        <td>Attendance only</td>
                        <td><span class="price-highlight">ZAR 300</span></td>
                        <td><span class="price-highlight">ZAR 500</span></td>
                    </tr>
                </tbody>
            </table>
        ...
        <div class="reg-note">
            Registration fees are effective from <strong>1 June 2026</strong>. Fees are in South African Rand (ZAR) unless otherwise stated. Contact <a href="mailto:info@scmerd.org" style="color:var(--teal)">info@scmerd.org</a> for group or institutional rates.
        </div>
    </div>
</section>
    ...
    <div class="section-inner">
        ...
        <div class="venue-grid">
            <div class="venue-info">
                ...
                <p style="font-size:.9rem; color:rgba(255,238,219,.55); line-height:1.6;">The conference will also feature satellite online venues at partner universities across South Africa, making it accessible to delegates who cannot attend in person.</p>
            </div>
            <div class="venue-map">
                <div class="venue-photo">
                    <img src="/images/15.jpeg" alt="Conference venue">
                </div>
                <iframe
    ...
    <div class="section-inner">
        ...
        <div class="partners-logo-grid">
            <a class="partner-logo-card" href="https://www.uj.ac.za/" target="_blank">
                <span class="partner-logo-mark">UJ</span>
            ...
            <a class="partner-logo-card" href="https://www.up.ac.za/" target="_blank">
                <span class="partner-logo-mark">UP</span>
            ...
            <a class="partner-logo-card" href="https://www.unisa.ac.za/" target="_blank">
                <span class="partner-logo-mark">UNISA</span>
            ...
            <a class="partner-logo-card" href="https://www.tut.ac.za/" target="_blank">
                <span class="partner-logo-mark">TUT</span>
            ...
            <a class="partner-logo-card" href="https://vut.ac.za/" target="_blank">
                <span class="partner-logo-mark">VUT</span>
            ...
            <a class="partner-logo-card" href="https://www.dut.ac.za/" target="_blank">
                <span class="partner-logo-mark">DUT</span>
    ...
    <div class="section-inner">
        <div class="contact-grid">
            <div class="contact-info">
                ...
                <p>For any queries or questions regarding the conference, we are here to assist you with information about submissions, registration, speaker invitations, or any other conference-related matters.</p>
            ...
            <div class="contact-details">
                ...
                <div class="contact-card">
                    ...
                    <p>Microsoft CMT3 · <a href="https://cmt3.research.microsoft.com/SCMERD2025" target="_blank" style="color:var(--teal); text-decoration:none;">cmt3.research.microsoft.com/SCMERD2025</a></p>
                </div>
                <div class="contact-photo">
                    <img src="/images/16.jpeg" alt="Conference networking">
                </div>
            </div>
        </div>
    </div>
