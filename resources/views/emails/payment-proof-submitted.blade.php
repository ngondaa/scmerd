...
<table cellpadding="6" cellspacing="0" border="0">
    ...
    <tr><th align="left">Package</th><td>{{ $package['name'] ?? ucfirst((string) $user->registration_package) }}</td></tr>
    <tr><th align="left">Includes</th><td>{{ $package['description'] ?? 'Conference registration' }}</td></tr>
    <tr><th align="left">Amount due</th><td>{{ $package['display_price'] ?? '—' }}</td></tr>
