...
@media (max-width:900px){
  ...
  .site-nav-cluster{width:auto;flex:1;justify-content:flex-end;gap:8px;}
  .nav-right{gap:8px;}
  .nav-links{
...
@media (max-width:380px){
  .site-nav{gap:8px;}
  .site-nav-logo-img{height:38px;max-width:96px;}
  .nav-right{gap:4px;}
  .nav-cta{padding:7px 9px;font-size:12px;}
